...
// questions : 
// questions {String::from} ?
// variable ki aage _ lagane ka kya purpose hai ?
// meata data and heap data ?
...
// // x = stack {len : 4 , ptr = |R|U|S|T , capacity = 4 };

// // pointer = ptr : 1000 (first address is strored of the sting 1000)
// // address    value
// // 1000 = R
// // 1001 = U
// // 1002 = S
...
// x = stack ----address of Rust---in heap ---> 1000
// y = stack ----address of Rust---in heap ---> 1000
// z = stack ----address of Rust---in heap ---> 1000
// c = stack ----address of Rust---in heap ---> 1000
